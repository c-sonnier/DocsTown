class DashboardsController < ApplicationController
  ...
  def show
    @votes = Current.user.votes.includes(:draft_version, documentation_task: :draft_versions).order(created_at: :desc).load
    total = @votes.size
    winning = @votes.count { |v| v.draft_version.winner? }
